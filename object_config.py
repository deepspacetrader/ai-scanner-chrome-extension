...
OBJECT_CONFIG = {
    ...
    "person": {
        ...
        "prompt": "Identify this person, especially world leaders or celebrities.",
        "llm_query": "Identify this person. Is it a world leader or public figure? Provide name and role if known, otherwise describe appearance.",
        "category": "Humans",
        "is_analyzable": True
    },
    "scene": {
        ...
        "llm_query": "Identify the key elements, mood, and context of this scene.",
        "category": "Misc",
        "is_analyzable": True
    },
    ...
    # "traffic light": {"color": "#FF0000", "task": "<DETAILED_CAPTION>", "prompt": "What color is the traffic light?", "llm_query": "Identify traffic light status.", "category": "Outdoors", "is_analyzable": False},
    ...
    # --- Accessories ---
    # "backpack": {"color": "#FFFF00", "task": "<DETAILED_CAPTION>", "prompt": "What brand is this backpack?", "llm_query": "Identify backpack brand/type.", "category": "Accessories", "is_analyzable": True},
    ...
    # "handbag": {"color": "#FFFF00", "task": "<DETAILED_CAPTION>", "prompt": "What brand is this handbag?", "llm_query": "Identify handbag brand.", "category": "Accessories", "is_analyzable": True},
    ...
    # "suitcase": {"color": "#FFFF00", "task": "<DETAILED_CAPTION>", "prompt": "What brand is this suitcase?", "llm_query": "Identify suitcase brand.", "category": "Accessories", "is_analyzable": True},
    ...
    # "skis": {"color": "#00FFFF", "task": "<DETAILED_CAPTION>", "prompt": "What brand are these skis?", "llm_query": "Identify skis brand.", "category": "Sports", "is_analyzable": True},
    # "snowboard": {"color": "#00FFFF", "task": "<DETAILED_CAPTION>", "prompt": "What brand is this snowboard?", "llm_query": "Identify snowboard brand.", "category": "Sports", "is_analyzable": True},
    # "sports ball": {"color": "#00FFFF", "task": "<DETAILED_CAPTION>", "prompt": "What kind of ball is this?", "llm_query": "Identify the sport for this ball.", "category": "Sports", "is_analyzable": True},
    ...
    # "skateboard": {"color": "#00FFFF", "task": "<DETAILED_CAPTION>", "prompt": "What is on the graphic of this skateboard?", "llm_query": "Describe skateboard graphic.", "category": "Sports", "is_analyzable": True},
    # "surfboard": {"color": "#00FFFF", "task": "<DETAILED_CAPTION>", "prompt": "What brand is this surfboard?", "llm_query": "Identify surfboard brand.", "category": "Sports", "is_analyzable": True},
    # "tennis racket": {"color": "#00FFFF", "task": "<DETAILED_CAPTION>", "prompt": "What brand is this racket?", "llm_query": "Identify racket brand.", "category": "Sports", "is_analyzable": True},

    # --- Household/Kitchen ---
    # "bottle": {"color": "#FF4444", "task": "<DETAILED_CAPTION>", "prompt": "What is in this bottle?", "llm_query": "Identify bottle content/brand.", "category": "Household", "is_analyzable": True},
    ...
    # "cup": {"color": "#FF4444", "task": "<DETAILED_CAPTION>", "prompt": "What brand or logo is on this cup?", "llm_query": "Identify cup branding.", "category": "Household", "is_analyzable": True},
    ...
    # "bowl": {"color": "#FF4444", "task": "<DETAILED_CAPTION>", "prompt": "What is in this bowl?", "llm_query": "Identify bowl contents.", "category": "Household", "is_analyzable": True},
    ...
    # "apple": {"color": "#CCFF00", "task": "<DETAILED_CAPTION>", "prompt": "What type of apple is this?", "llm_query": "Identify apple variety.", "category": "Food", "is_analyzable": True},
    # "sandwich": {"color": "#CCFF00", "task": "<DETAILED_CAPTION>", "prompt": "What kind of sandwich is this?", "llm_query": "Identify sandwich type/ingredients.", "category": "Food", "is_analyzable": True},
    # "orange": {"color": "#CCFF00", "task": "<DETAILED_CAPTION>", "prompt": "Is this an orange or a tangerine?", "llm_query": "Identify citrus type.", "category": "Food", "is_analyzable": False},
    ...
    # "hot dog": {"color": "#CCFF00", "task": "<DETAILED_CAPTION>", "prompt": "What toppings are on this hot dog?", "llm_query": "Describe hot dog toppings.", "category": "Food", "is_analyzable": True},
    # "pizza": {"color": "#CCFF00", "task": "<DETAILED_CAPTION>", "prompt": "What toppings are on this pizza?", "llm_query": "Identify pizza toppings.", "category": "Food", "is_analyzable": True},
    # "donut": {"color": "#CCFF00", "task": "<DETAILED_CAPTION>", "prompt": "What kind of donut is this?", "llm_query": "Identify donut type.", "category": "Food", "is_analyzable": True},
    # "cake": {"color": "#CCFF00", "task": "<DETAILED_CAPTION>", "prompt": "What kind of cake is this?", "llm_query": "Identify cake type.", "category": "Food", "is_analyzable": True},
    ...
    # "potted plant": {"color": "#228B22", "task": "<DETAILED_CAPTION>", "prompt": "What species of plant is this?", "llm_query": "Identify plant species.", "category": "Outdoors", "is_analyzable": True},
    ...
    # --- Electronics ---
    # "tv": {"color": "#0080FF", "task": "<DETAILED_CAPTION>", "prompt": "What is showing on this TV?", "llm_query": "Describe TV content.", "category": "Electronics", "is_analyzable": True},
    # "laptop": {"color": "#0080FF", "task": "<DETAILED_CAPTION>", "prompt": "What brand of laptop is this?", "llm_query": "Identify laptop brand.", "category": "Electronics", "is_analyzable": True},
    # "mouse": {"color": "#0080FF", "task": "<DETAILED_CAPTION>", "prompt": "What brand of mouse is this?", "llm_query": "Identify mouse brand.", "category": "Electronics", "is_analyzable": True},
    ...
    # "keyboard": {"color": "#0080FF", "task": "<DETAILED_CAPTION>", "prompt": "What brand of keyboard is this?", "llm_query": "Identify keyboard brand.", "category": "Electronics", "is_analyzable": True},
    # "cell phone": {"color": "#0080FF", "task": "<DETAILED_CAPTION>", "prompt": "What model of phone is this?", "llm_query": "Identify phone model.", "category": "Electronics", "is_analyzable": True},
    # "microwave": {"color": "#0080FF", "task": "<DETAILED_CAPTION>", "prompt": "What brand of microwave is this?", "llm_query": "Identify microwave brand.", "category": "Electronics", "is_analyzable": False},
    # "oven": {"color": "#0080FF", "task": "<DETAILED_CAPTION>", "prompt": "What brand of oven is this?", "llm_query": "Identify oven brand.", "category": "Electronics", "is_analyzable": False},
    # "toaster": {"color": "#0080FF", "task": "<DETAILED_CAPTION>", "prompt": "What brand of toaster is this?", "llm_query": "Identify toaster brand.", "category": "Electronics", "is_analyzable": False},
    ...
    # "refrigerator": {"color": "#0080FF", "task": "<DETAILED_CAPTION>", "prompt": "What brand of refrigerator is this?", "llm_query": "Identify refrigerator brand.", "category": "Household", "is_analyzable": False},

    # --- Misc ---
    # "book": {"color": "#A52A2A", "task": "<DETAILED_CAPTION>", "prompt": "What is the title of this book?", "llm_query": "Identify book title and author.", "category": "Accessories", "is_analyzable": True},
    # "clock": {"color": "#A52A2A", "task": "<DETAILED_CAPTION>", "prompt": "What time is it on this clock?", "llm_query": "Identify time on clock.", "category": "Household", "is_analyzable": True},
    ...
    # "hair drier": {"color": "#A52A2A", "task": "<DETAILED_CAPTION>", "prompt": "What brand is this hair drier?", "llm_query": "Identify hair drier brand.", "category": "Electronics", "is_analyzable": False},
